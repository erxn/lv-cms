        ...
        <nav class="sidebar">
            <div class="sidebar-header">
                <a href="#" class="sidebar-brand">
                    <span style="color:#ef392b;font-weight:bold;font-size:smaller;">MyLaravel</span><span>CMS</span>
                </a>
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item{{ ToolHelp::set_active('admin/home') }}">
                    ...
                    <li class="nav-item{{ ToolHelp::set_active('admin/category') }}">
                        <a href="/admin/category" class="nav-link">
                            <i class="link-icon" data-feather="message-square"></i>
                            <span class="link-title">Category</span>
                        </a>
                    </li>
                    <li class="nav-item{{ ToolHelp::set_active('admin/post') }}">
                    ...
                    <li class="nav-item{{ ToolHelp::set_active('admin/profile') }}">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                <p class="text-muted text-center text-md-left">Copyright © 2020 <a href="https://www.nobleui.com"
                        target="_blank">MyLaravelCMS</a>. All rights reserved</p>
